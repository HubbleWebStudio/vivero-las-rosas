...
# Stacks curados para Hubble Web Studio (Next.js 14 + TS + Tailwind v4 + Shadcn).
# Los stacks de mobile (swiftui, react-native, flutter, jetpack-compose) y de otros
# frameworks web (vue, svelte, astro, nuxtjs, angular, laravel, threejs) fueron
# descartados al importar el toolkit el 2026-04-23.
STACK_CONFIG = {
